...
static IRQn_Type DMA_Map_Stream_IRQn(hwDMA_Stream_Index index)
{
        switch(index)
        {
#if defined (DMA1_BASE)
                case hwDMA_Stream_Index_0: return DMA1_Stream0_IRQn;
                case hwDMA_Stream_Index_1: return DMA1_Stream1_IRQn;
                case hwDMA_Stream_Index_2: return DMA1_Stream2_IRQn;
                case hwDMA_Stream_Index_3: return DMA1_Stream3_IRQn;
                case hwDMA_Stream_Index_4: return DMA1_Stream4_IRQn;
                case hwDMA_Stream_Index_5: return DMA1_Stream5_IRQn;
                case hwDMA_Stream_Index_6: return DMA1_Stream6_IRQn;
                case hwDMA_Stream_Index_7: return DMA1_Stream7_IRQn;
#endif //DMA1_BASE
#if defined (DMA2_BASE)
                case hwDMA_Stream_Index_8: return DMA2_Stream0_IRQn;
                case hwDMA_Stream_Index_9: return DMA2_Stream1_IRQn;
                case hwDMA_Stream_Index_10: return DMA2_Stream2_IRQn;
                case hwDMA_Stream_Index_11: return DMA2_Stream3_IRQn;
                case hwDMA_Stream_Index_12: return DMA2_Stream4_IRQn;
                case hwDMA_Stream_Index_13: return DMA2_Stream5_IRQn;
                case hwDMA_Stream_Index_14: return DMA2_Stream6_IRQn;
                case hwDMA_Stream_Index_15: return DMA2_Stream7_IRQn;
#endif //DMA2_BASE
#if defined (BDMA_BASE)
                case hwDMA_Stream_Index_16: return BDMA_Channel0_IRQn;
                case hwDMA_Stream_Index_17: return BDMA_Channel1_IRQn;
                case hwDMA_Stream_Index_18: return BDMA_Channel2_IRQn;
                case hwDMA_Stream_Index_19: return BDMA_Channel3_IRQn;
                case hwDMA_Stream_Index_20: return BDMA_Channel4_IRQn;
                case hwDMA_Stream_Index_21: return BDMA_Channel5_IRQn;
                case hwDMA_Stream_Index_22: return BDMA_Channel6_IRQn;
                case hwDMA_Stream_Index_23: return BDMA_Channel7_IRQn;
#endif //BDMA_BASE
                default: break;
        }
...
static void DMA_Enable_Stream_Clock(hwDMA_Stream_Index stream_index)
{
        switch(stream_index)
        {
#if defined (DMA1_BASE)
...
hwDMA_OpResult DMA_Stream_Init(hwDMA_Stream_Index stream_index)
{
        ...
        DMA_Enable_Stream_Clock(stream_index);

        IRQn_Type stream_irqn = DMA_Map_Stream_IRQn(stream_index);
        if(stream_irqn != NonMaskableInt_IRQn)
        {
                HAL_NVIC_SetPriority(stream_irqn, DMA_IRQ_NVIC_PRIORITY, DMA_IRQ_NVIC_SUB_PRIORITY);
                HAL_NVIC_EnableIRQ(stream_irqn);
        }
...
hwDMA_OpResult DMA_Stream_DeInit(hwDMA_Stream_Index stream_index)
{
        ...
        if(stream_irqn != NonMaskableInt_IRQn)
        {
                HAL_NVIC_DisableIRQ(stream_irqn);
        }
